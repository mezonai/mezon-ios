...
@objc public protocol ASGestureRecognizerDelegate: AnyObject {
    ...
    @objc optional func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldReceive press: UIPress) -> Bool
    @available(iOS 13.4, *)
    @objc optional func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldReceive event: UIEvent) -> Bool
}

@objc public protocol ASScrollViewDelegate: AnyObject {
    ...
    @objc optional func viewForZooming(in scrollView: UIScrollView) -> UIView?
    @objc optional func scrollViewWillBeginZooming(_ scrollView: UIScrollView, with view: UIView?)
    @objc optional func scrollViewDidEndZooming(_ scrollView: UIScrollView, with view: UIView?, atScale scale: CGFloat)
    @objc optional func scrollViewShouldScroll(toTop scrollView: UIScrollView) -> Bool
    @objc optional func scrollViewDidScroll(toTop scrollView: UIScrollView)
    @objc optional func scrollViewDidChangeAdjustedContentInset(_ scrollView: UIScrollView)
    @objc optional func accessibilityScrollStatus(for scrollView: UIScrollView) -> String?
    @objc optional func accessibilityAttributedScrollStatus(for scrollView: UIScrollView) -> NSAttributedString?
}
